      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 sm:py-8">
        <div className="flex flex-col md:flex-row md:justify-between">
          <div className="mb-6 md:mb-0 flex justify-center md:justify-start">
            <a href="https://flowbite.com/" className="flex items-center">
              <img
                className="w-30 sm:max-w-[200px] object-contain"
                src="logo.png"
                alt="Zelus logo"
              />
            </a>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 sm:gap-6">
            <div>
              <h2 className="mb-4 text-sm font-semibold text-gray-900 uppercase">Recursos</h2>
            ...
            <div>
              ...
              <ul className="text-gray-500 font-medium space-y-3">
                <li>
                  <a href="https://github.com/gaherrera00/assistenciaTecnica" className="hover:underline">Github</a>
                </li>
                <li>
        ...
        <hr
          ...
          style={{
            border: 'none',
            height: '1px',
            backgroundImage: 'linear-gradient(to right, transparent, #084438, transparent)',
          }}
        />
        <div className="flex flex-col items-center sm:flex-row sm:justify-between gap-4">
          <span className="text-sm text-gray-500 text-center sm:text-left">
            © 2025 <a href="#" className="hover:underline">Zelus™</a>. Todos os direitos reservados.
          </span>
          <div className="flex justify-center gap-4 sm:gap-6">
            <a href="#" className="text-gray-500 hover:text-gray-900" aria-label="Facebook page">
            ...
            <a href="#" className="text-gray-500 hover:text-gray-900" aria-label="Discord community">
            ...
            <a href="#" className="text-gray-500 hover:text-gray-900" aria-label="Twitter page">
            ...
            <a href="#" className="text-gray-500 hover:text-gray-900" aria-label="GitHub account">
